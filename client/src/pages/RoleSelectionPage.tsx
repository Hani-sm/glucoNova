  ...
  return (
    <PublicLayout>
      ...
      >
        ...
        <p className="text-2xl font-semibold text-emerald-500 text-center mb-3">Select Your Role</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
          ...
          >
            <div className="flex flex-col items-center text-center space-y-4">
              <div className="h-16 w-16 rounded-full bg-emerald-700/10 border border-emerald-700/20 flex items-center justify-center group-hover:bg-emerald-700/20 transition-colors">
                <User className="h-8 w-8 text-emerald-500" />
              </div>
              
              <div className="space-y-2">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-700/10 border border-emerald-700/20">
                  <span className="text-xs font-semibold text-emerald-500 uppercase tracking-wide">Patient</span>
                </div>
              ...
              <Button
                ...
                className="w-full h-11 text-base bg-white/5 border border-white/10 text-emerald-500 hover:bg-emerald-700/10 hover:border-emerald-700/30 transition-all"
                variant="outline"
          ...
          >
            <div className="flex flex-col items-center text-center space-y-4">
              ...
              <div className="space-y-2">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-700/10 border border-emerald-700/20">
                  <span className="text-xs font-semibold text-emerald-500 uppercase tracking-wide">Provider</span>
                </div>
