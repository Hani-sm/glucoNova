      ...
      <div className="flex flex-col flex-1 overflow-hidden relative" style={{ zIndex: 10, marginLeft: '280px' }}>
        ...
        <main className="flex-1 overflow-y-auto">
          <div className="w-full" style={{ padding: '24px 32px' }}>
            <div className="mb-6">
              <h1 className="text-3xl font-bold mb-1">Reports & Medical Documents</h1>
              <p className="text-muted-foreground">Upload, manage, and analyze your medical reports</p>
            </div>
                  ...
                  <>
                    {(reportsData as any)?.reports?.length > 0 ? (
                      ...
                      <Card className="p-8 glass-card text-center">
                        ...
                        <p className="text-muted-foreground mb-4">Upload your first medical report to get started</p>
                        <button
                          onClick={() => setActiveTab('upload')}
                    ...
                    <Card className="p-8 glass-card">
                      <div className="text-center">
                        ...
                        <p className="text-muted-foreground mb-6">
                          Go to Documents & OCR page to upload and analyze your reports
                        </p>
                  ...
                  <Card className="p-8 glass-card">
                    <div className="grid grid-cols-3 gap-4 mb-8">
                      <div className="text-center p-4 rounded-lg bg-secondary/50">
                        <p className="text-sm text-muted-foreground mb-1">Average A1C Trend</p>
                        <p className="text-2xl font-bold text-primary">--</p>
                        <p className="text-xs text-muted-foreground mt-1">Based on reports</p>
                      </div>
                      <div className="text-center p-4 rounded-lg bg-secondary/50">
                        <p className="text-sm text-muted-foreground mb-1">BMI Trend</p>
                        <p className="text-2xl font-bold text-primary">--</p>
                        <p className="text-xs text-muted-foreground mt-1">Based on reports</p>
                      </div>
                      <div className="text-center p-4 rounded-lg bg-secondary/50">
                    ...
                    <div className="text-center">
                      ...
                      <p className="text-foreground font-medium mb-1">Trend Analysis Coming Soon</p>
                      <p className="text-muted-foreground text-sm">Upload more reports to see trend analysis</p>
                    </div>
                  </Card>
                )}
              </div>
