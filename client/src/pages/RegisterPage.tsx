          ...
          <div>
            ...
            <div className="flex gap-2">
              <Button
                ...
                className={role === 'patient' ? 'flex-1 h-12 text-base bg-emerald-600 hover:bg-emerald-500 text-white' : 'flex-1 h-12 text-base bg-white/5 border border-white/10 text-gray-200 hover:bg-white/10'}
              ...
              <Button
                ...
                className={role === 'doctor' ? 'flex-1 h-12 text-base bg-emerald-600 hover:bg-emerald-500 text-white' : 'flex-1 h-12 text-base bg-white/5 border border-white/10 text-gray-200 hover:bg-white/10'}
