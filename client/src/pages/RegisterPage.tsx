    ...
    <PublicLayout>
      ...
      >
        ...
        <div className="flex items-center justify-center gap-3 mb-8">
          <div className="flex items-center gap-3 px-4 py-2 rounded-lg bg-emerald-400/10 border border-emerald-400/20">
            {role === 'patient' ? (
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            <Label htmlFor="name" className="text-gray-200 text-base font-medium mb-2 block">Full Name</Label>
            <Input
              id="name"
              type="text"
              value={name}
          ...
          <div>
            <Label htmlFor="confirmPassword" className="text-gray-200 text-base font-medium mb-2 block">Confirm Password</Label>
            <Input
              id="confirmPassword"
              type="password"
