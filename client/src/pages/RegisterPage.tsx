...
export default function RegisterPage() {
  ...
  return (
    <PublicLayout>
      <Card 
        className="w-full max-w-5xl backdrop-blur-md bg-white/8 border border-white/15 rounded-2xl p-24 shadow-2xl"
      >
        <h1 className="text-6xl font-bold text-white text-center mb-4">GlucoNova</h1>
        <p className="text-3xl font-semibold text-emerald-400 text-center mb-12">Create Account</p>
        
        <form onSubmit={handleSubmit} className="space-y-8">
          <div>
            <Label htmlFor="name" className="text-gray-200 text-lg mb-4 block">Full Name</Label>
            <Input
              id="name"
              type="text"
              value={name}
          ...
          <div>
            <Label htmlFor="email" className="text-gray-200 text-lg mb-4 block">Email</Label>
            <Input
              id="email"
              type="email"
              value={email}
          ...
          <div>
            <Label htmlFor="confirmPassword" className="text-gray-200 text-lg mb-4 block">Confirm Password</Label>
            <Input
              id="confirmPassword"
              type="password"
          ...
          <div>
            <Label className="text-gray-200 text-lg mb-4 block">Role</Label>
            <div className="flex gap-4">
              <Button
                type="button"
                onClick={() => setRole('patient')}
                className={role === 'patient' ? 'flex-1 h-16 text-xl bg-emerald-600 hover:bg-emerald-500 text-white' : 'flex-1 h-16 text-xl bg-white/5 border border-white/10 text-gray-200 hover:bg-white/10'}
              ...
              <Button
                ...
                className={role === 'doctor' ? 'flex-1 h-16 text-xl bg-emerald-600 hover:bg-emerald-500 text-white' : 'flex-1 h-16 text-xl bg-white/5 border border-white/10 text-gray-200 hover:bg-white/10'}
